! function() {
    ...
    class K {
        ...
        supportsImageBitmapRendering() {
            const e = navigator.userAgent.indexOf("Firefox") > -1;
            return !!window.createImageBitmap && "undefined" != typeof ImageBitmapRenderingContext && !e
        }
        render({
            source: e,
            filter: t,
    ...
    const ie = "data-modifiers",
        ...
        ce = (e, t) => {
            ...
            let s = 0;
            const c = () => {
                e.readyState >= 1 && o(), s = requestAnimationFrame(c)
            };
            e.addEventListener("pause", (() => {
                ...
                s = requestAnimationFrame(c)
            })), e.paused || (s = s || requestAnimationFrame(c))
        },
        ue = new Map;
    r((() => {
        document.querySelectorAll(`video[${ie}], video[${ne}]`).forEach((e => ue.set(e, (() => {
            const e = document.createElement("canvas");
            return e.style.position = "absolute", e.style.top = "0", e.style.left = "0", e
        })())));
        i((() => {
            ue.forEach(((e, t) => ce(t, e)))
        }), {
            runOnLoad: !0
        })
    }))
